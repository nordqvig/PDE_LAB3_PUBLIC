...
def testing():
    solver1 = Solver(3, 0, 1)
    solver1.solve_dirichlet()
    print(solver1.sol_vec_dirichlet)
    solver1.calculate_error()
    print(solver1.error_dirichlet)
